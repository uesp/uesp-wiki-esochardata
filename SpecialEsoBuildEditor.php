...
class SpecialEsoBuildEditor extends SpecialPage 
{
	...
	function execute( $par ) 
	{
		...
		$out->addHeadItem("uesp-esobuildeditor2-js", "<script src='//esobuilds-static.uesp.net/resources/esoEditBuild.js?version=28June2017'></script>");
		$out->addHeadItem("uesp-esobuildeditor3-js", "<script src='//esobuilds-static.uesp.net/resources/esoBuildCombat.js?version=28June2017'></script>");
